...
class WebDriverProxy:
    ...
    def get_screenshot(
        ...
        try:
            ...
            logger.info("configs: ", current_app.config)
            logger.info("replace errors: ",
                        current_app.config["SCREENSHOT_REPLACE_UNEXPECTED_ERRORS"])
            logger.info("wait to show: ",
                        current_app.config["SCREENSHOT_WAIT_FOR_ERROR_MODAL_VISIBLE"])
            logger.info("wait to disappear: ",
