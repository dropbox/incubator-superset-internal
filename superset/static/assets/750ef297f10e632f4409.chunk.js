"use strict";(globalThis.webpackChunksuperset=globalThis.webpackChunksuperset||[]).push([[9678],{49576:(e,t,a)=>{a.d(t,{Z:()=>g});var l=a(67294),i=a(51995),n=a(38097),r=a(11965);const o=i.iK.label`
  cursor: pointer;
...
`;function C({bulkSelectEnabled:e,loading:t,prepareRow:a,renderCard:l,rows:i,showThumbnails:n}){return l?(0,w.tZ)(Z,{showThumbnails:n},t&&0===i.length&&[...new Array(25)].map(((e,a)=>(0,w.tZ)("div",{key:a},l({loading:t})))),i.length>0&&i.map((i=>l?(a(i),(0,w.tZ)(S,{className:m()({"card-selected":e&&i.isSelected,"bulk-select":e}),key:i.id,onClick:t=>{return a=t,l=i.toggleRowSelected,void(e&&(a.preventDefault(),a.stopPropagation(),l()));var a,l},role:"none"},l({...i.original,loading:t}))):null))):null}var $=a(68135),k=(a(15306),a(18446)),F=a.n(k),P=a(79521),I=a(35755),T=a(15926),M=a.n(T);const U={encode:e=>void 0===e?void 0:M().encode(e).replace(/\+/g,"%2B"),decode:e=>void 0===e||Array.isArray(e)?void 0:M().decode(e)};class R extends Error{constructor(...e){super(...e),this.name="ListViewError"}}function A(e,t){return e.map((({id:e,urlDisplay:a,operator:l})=>({id:e,urlDisplay:a,operator:l,value:t[a||e]})))}function _(e,t){const a=[],l={};return Object.keys(e).forEach((t=>{const i={id:t,value:e[t]};l[t]=i,a.push(i)})),t.forEach((e=>{const t=e.urlDisplay||e.id,a=l[t];a&&(a.operator=e.operator,a.id=e.id)})),a}var V=a(49238);const z=o.iK.div`
  width: ${200}px;
`,B=(0,o.iK)(b.Z.Search)`
  color: ${({theme:e})=>e.colors.grayscale.light1};
`,E=(0,o.iK)(c.oc)`
  border-radius: ${({theme:e})=>e.gridUnit}px;
`;function K({Header:e,name:t,initialValue:a,onSubmit:l}){const[i,n]=(0,d.useState)(a||""),r=()=>{i&&l(i.trim().replace(/\+/g,"%2B"))};return(0,w.tZ)(z,null,(0,w.tZ)(V.lX,null,e),(0,w.tZ)(E,{allowClear:!0,placeholder:(0,s.t)("Type a value"),name:t,value:i,onChange:e=>{n(e.currentTarget.value),""===e.currentTarget.value&&l("")},onPressEnter:r,onBlur:r,prefix:(0,w.tZ)(B,{iconSize:"l"})}))}var O=a(4715);const N=o.iK.div`
  display: inline-flex;
...
`,ee={Cell:({row:e})=>(0,w.tZ)(v.Z,r()({},e.getToggleRowSelectedProps(),{id:e.id})),Header:({getToggleAllRowsSelectedProps:e})=>(0,w.tZ)(v.Z,r()({},e(),{id:"header-toggle-all"})),id:"selection",size:"sm"},te=o.iK.div`
