...
`,f=e=>({maxHeight:"100vh",maxWidth:"100vw",minHeight:e?109:174,minWidth:"380px",enable:{bottom:!0,bottomLeft:!1,bottomRight:!0,left:!1,top:!1,topLeft:!1,topRight:!1,right:!0}}),b=e=>{let{children:t,disablePrimaryButton:n=!1,primaryButtonLoading:r=!1,onHide:a,onHandledPrimaryAction:s,primaryButtonName:u=(0,c.t)("OK"),primaryButtonType:h="primary",show:b,name:_,title:R,width:E,maxWidth:N,responsive:S=!1,centered:C,footer:O,hideFooter:y,wrapProps:x,draggable:T=!1,resizable:Z=!1,resizableConfig:w=f(y),draggableConfig:A,destroyOnClose:k,...I}=e;const $=(0,i.useRef)(null),[D,P]=(0,i.useState)(),[U,L]=(0,i.useState)(!0);let M;i.isValidElement(O)&&(M=i.cloneElement(O,{closeModal:a}));const F=l()(M)?[(0,d.tZ)(g.Z,{key:"back",onClick:a,cta:!0},(0,c.t)("Cancel")),(0,d.tZ)(g.Z,{key:"submit",buttonStyle:h,disabled:n,loading:r,onClick:s,cta:!0},u)]:M,z=E||(S?"100vw":"600px"),B=!(Z||T),W=(0,i.useMemo)((()=>0===Object.keys(w).length?f(y):w),[y,w]);return(0,d.tZ)(v,o()({centered:!!C,onOk:s,onCancel:a,width:z,maxWidth:N,responsive:S,visible:b,title:(0,d.tZ)((()=>T?(0,d.tZ)("div",{className:"draggable-trigger",onMouseOver:()=>U&&L(!1),onMouseOut:()=>!U&&L(!0)},R):(0,d.tZ)(i.Fragment,null,R)),null),closeIcon:(0,d.tZ)("span",{className:"close","aria-hidden":"true"},"×"),footer:y?null:F,hideFooter:y,wrapProps:{"data-test":`${_||R}-modal`,...x},modalRender:e=>Z||T?(0,d.tZ)(m(),o()({disabled:!T||U,bounds:D,onStart:(e,t)=>((e,t)=>{var n,r,o;const{clientWidth:a,clientHeight:l}=null==(n=window)||null==(r=n.document)?void 0:r.documentElement,i=null==$||null==(o=$.current)?void 0:o.getBoundingClientRect();i&&P({left:-(null==i?void 0:i.left)+(null==t?void 0:t.x),right:a-((null==i?void 0:i.right)-(null==t?void 0:t.x)),top:-(null==i?void 0:i.top)+(null==t?void 0:t.y),bottom:l-((null==i?void 0:i.bottom)-(null==t?void 0:t.y))})})(0,t)},A),Z?(0,d.tZ)(p.e,o()({className:"resizable"},W),(0,d.tZ)("div",{className:"resizable-wrapper",ref:$},e)):(0,d.tZ)("div",{ref:$},e)):e,mask:B,draggable:T,resizable:Z,destroyOnClose:k},I),t)};b.displayName="Modal";const _={okButtonProps:{className:"modal-functions-ok-button"},cancelButtonProps:{className:"modal-functions-cancel-button"}},R=Object.assign(b,{error:e=>u.xT.error({...e,..._}),warning:e=>u.xT.warning({...e,..._}),confirm:e=>u.xT.confirm({...e,..._}),useModal:u.xT.useModal})},64158:(e,t,n)=>{"use strict";n.d(t,{Z:()=>u}),n(67294);var r=n(51995),o=n(94184),a=n.n(o),l=n(11965);const i=r.iK.ul`
...
`,v=Object.assign(m,{TabPane:d}),f=u},58593:(e,t,n)=>{"use strict";n.d(t,{u:()=>c});var r=n(5872),o=n.n(r),a=n(67294),l=n(51995),i=n(11965),s=n(31097);const c=e=>{const t=(0,l.Fg)();return(0,i.tZ)(a.Fragment,null,(0,i.tZ)(i.xB,{styles:i.iv`
          .ant-tooltip-open {
            display: inline-block;
            &::after {
              content: '';
