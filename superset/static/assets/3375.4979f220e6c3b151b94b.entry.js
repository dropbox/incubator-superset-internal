...
`,xt=(0,it.Q)("date-filter-control");function Dt(t){const{value:e=at.X5,endpoints:a,onChange:n,type:r}=t,[o,s]=(0,i.useState)(e),[d,p]=(0,i.useState)(!1),h=(0,i.useMemo)((()=>{return t=e,C.has(t)?"Common":E.has(t)?"Calendar":"No filter"===t?"No filter":J(t).matchedFlag?"Custom":"Advanced";var t}),[e]),[m,Z]=(0,i.useState)(h),[g,v]=(0,i.useState)(e),[f,b]=(0,i.useState)(e),[w,N]=(0,i.useState)(!1),[x,D]=(0,i.useState)(e),[S,T]=(0,i.useState)(e);function $(){b(e),Z(h),p(!1)}(0,i.useEffect)((()=>{bt(e,a).then((({value:t,error:a})=>{a?(D(a||""),N(!1),T(e||"")):("Common"===h||"Calendar"===h||"No filter"===h?(s(e),T("error"===r?(0,c.t)("Default value is required"):t||"")):(s(t||""),T(e||"")),N(!0)),v(e)}))}),[e]),(0,nt.bX)((()=>{g!==f&&bt(f,a).then((({value:t,error:e})=>{e?(D(e||""),N(!1)):(D(t||""),N(!0)),v(f)}))}),lt.M$,[f]);const M=(0,u.Fg)(),k=(0,ot.tZ)(Et,null,(0,ot.tZ)("div",{className:"control-label"},(0,c.t)("RANGE TYPE")),(0,ot.tZ)(wt,{ariaLabel:(0,c.t)("RANGE TYPE"),options:y,value:m,onChange:function(t){"No filter"===t&&b("No filter"),Z(t)},sortComparator:(0,tt.m)("order")}),"No filter"!==m&&(0,ot.tZ)(_.iz,null),"Common"===m&&(0,ot.tZ)(st,{value:f,onChange:b}),"Calendar"===m&&(0,ot.tZ)(ut,{value:f,onChange:b}),"Advanced"===m&&(0,ot.tZ)(yt,{value:f,onChange:b}),"Custom"===m&&(0,ot.tZ)(Zt,{value:f,onChange:b}),"No filter"===m&&(0,ot.tZ)("div",null),(0,ot.tZ)(_.iz,null),(0,ot.tZ)("div",null,(0,ot.tZ)("div",{className:"section-title"},(0,c.t)("Actual time range")),w&&(0,ot.tZ)("div",null,x),!w&&(0,ot.tZ)(Nt,{className:"warning"},(0,ot.tZ)(B.Z.ErrorSolidSmall,{iconColor:M.colors.error.base}),(0,ot.tZ)("span",{className:"text error"},x))),(0,ot.tZ)(_.iz,null),(0,ot.tZ)("div",{className:"footer"},(0,ot.tZ)(K.Z,{buttonStyle:"secondary",cta:!0,key:"cancel",onClick:$},(0,c.t)("CANCEL")),(0,ot.tZ)(K.Z,l()({buttonStyle:"primary",cta:!0,disabled:!w,key:"apply",onClick:function(){n(f),p(!1)}},xt("apply-button")),(0,c.t)("APPLY")))),A=(0,ot.tZ)(Nt,null,(0,ot.tZ)(B.Z.EditAlt,{iconColor:M.colors.grayscale.base}),(0,ot.tZ)("span",{className:"text"},(0,c.t)("Edit time range")));return(0,ot.tZ)(i.Fragment,null,(0,ot.tZ)(W.Z,t),(0,ot.tZ)(Ct,{placement:"right",trigger:"click",content:k,title:A,defaultVisible:d,visible:d,onVisibleChange:()=>{d?$():p(!0)},overlayStyle:{width:"600px"}},(0,ot.tZ)(et.u,{placement:"top",title:S},(0,ot.tZ)(j.Z,{className:"pointer",onClick:function(){b(e),Z(h),p(!0)}},o))))}},53350:(t,e,a)=>{a.d(e,{Q:()=>n});const n=(t,e=!1)=>(a,n=!1)=>{const l=n||e;if(!a&&t)return l?t:{"data-test":t};if(a&&!t)return l?a:{"data-test":a};if(!a&&!t)return console.warn('testWithId function has missed "prefix" and "id" params'),l?"":{"data-test":""};const i=`${t}__${a}`;return l?i:{"data-test":i}}}}]);