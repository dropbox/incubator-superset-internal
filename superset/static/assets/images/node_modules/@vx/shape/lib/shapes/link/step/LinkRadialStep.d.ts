...
export default function LinkRadialStep<Link, Node>({ className, innerRef, data, path, x, y, source, target, children, ...restProps }: LinkRadialStepProps<Link, Node> & Omit<React.SVGProps<SVGPathElement>, keyof LinkRadialStepProps<Link, Node>>): JSX.Element;
export {};
