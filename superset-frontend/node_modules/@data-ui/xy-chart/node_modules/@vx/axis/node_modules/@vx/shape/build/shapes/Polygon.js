...
function Polygon(_ref3) {
  var sides = _ref3.sides,
      ...
      stroke = _ref3$stroke === undefined ? 'black' : _ref3$stroke,
      restProps = _objectWithoutProperties(_ref3, ['sides', 'size', 'center', 'rotate', 'className', 'clickHandler', 'fill', 'strokeDasharray', 'strokeWidth', 'stroke']);
  ...
  return _react2.default.createElement('polygon', _extends({ points: points, className: className, fill: fill }, restProps));
}