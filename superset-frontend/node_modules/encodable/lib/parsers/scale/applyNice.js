  ...
  if ('nice' in config && typeof config.nice !== 'undefined' && 'nice' in scale) {
    ...
    if (typeof nice === 'boolean') {
      ...
      if (typeof nice === 'string') {
        timeScale.nice(type === _types.ScaleType.UTC ? utcIntervals[nice] : localTimeIntervals[nice]);
      } else {
        const {
          interval,
          step
        } = nice;
        const parsedInterval = (type === _types.ScaleType.UTC ? utcIntervals[interval] : localTimeIntervals[interval]).every(step);
