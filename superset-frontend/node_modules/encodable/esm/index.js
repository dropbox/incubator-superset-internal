...
export * from './options/resolvers'; // Export type guards

export { isFieldDef, isNonValueDef, isTypedFieldDef, isValueDef, isScaleFieldDef, isPositionFieldDef } from './typeGuards/ChannelDef';
export { isCompleteFieldDef, isCompleteValueDef } from './typeGuards/CompleteChannelDef'; // Export types

export * from './types'; // Re-export color and formatter registries
