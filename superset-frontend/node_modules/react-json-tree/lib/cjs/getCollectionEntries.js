...
function getCollectionEntries(type, collection, sortObjectKeys, limit) {
  ...
  if (type === 'Iterable') {
    ...
    limitedEntries = hasMore ? [].concat((0, _toConsumableArray2.default)(entries), (0, _toConsumableArray2.default)(getRanges(from + limit, from + 2 * limit - 1, limit))) : entries;
  } else {
    limitedEntries = isSubset ? getRanges(from, to, limit) : [].concat((0, _toConsumableArray2.default)(getEntriesBound(0, limit - 5).entries), (0, _toConsumableArray2.default)(getRanges(limit - 4, length - 5, limit)), (0, _toConsumableArray2.default)(getEntriesBound(length - 4, length - 1).entries));
  }
