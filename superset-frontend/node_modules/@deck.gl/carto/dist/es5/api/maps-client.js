...
function _getDataV() {
  _getDataV = (0, _asyncToGenerator2.default)(_regenerator.default.mark(function _callee(_ref) {
    var type, source, credentials, localCreds, apiVersion, url, connection, mapConfig, layergroup;
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            apiVersion = localCreds.apiVersion;
            connection = type === 'tileset' ? CONNECTIONS.BIGQUERY : CONNECTIONS.CARTO;
            _context.t0 = apiVersion;
            _context.next = _context.t0 === _mapsApiCommon.API_VERSIONS.V1 ? 7 : _context.t0 === _mapsApiCommon.API_VERSIONS.V2 ? 13 : 17;
            break;
