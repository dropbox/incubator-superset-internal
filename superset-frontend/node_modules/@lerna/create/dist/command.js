...
var require_child_process = __commonJS({
  "packages/child-process/index.js"(exports2) {
    ...
    function execSync(command2, args, opts) {
      return execa2.sync(command2, args, opts).stdout;
    }
    ...
    function spawnProcess(command2, args, opts) {
      const child = execa2(command2, args, opts);
...
var require_src = __commonJS({
  "libs/commands/create/src/index.ts"(exports2, module2) {
    ...
    var CreateCommand = class extends Command {
      ...
      gitConfig(prop) {
        return childProcess10.execSync("git", ["config", "--get", prop], this.execOpts);
      }
      ...
      setRepository() {
        try {
          const url2 = childProcess10.execSync("git", ["remote", "get-url", "origin"], this.execOpts);
