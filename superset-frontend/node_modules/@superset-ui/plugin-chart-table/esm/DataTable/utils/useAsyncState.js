...
import { useAsyncDebounce } from 'react-table'; // useAsyncDebounce in dist build of `react-table` requires regeneratorRuntime
...
export default function useAsyncState(initialValue, callback, wait = 200) {
  ...
  const onChange = useAsyncDebounce(callback, wait); // sync updated initialValue
