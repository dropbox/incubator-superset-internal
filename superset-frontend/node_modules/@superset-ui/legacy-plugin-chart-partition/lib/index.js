...
const metadata = new _core.ChartMetadata({
  ...
  description: (0, _core.t)('Compare the same summarized metric across multiple groups.'),
  name: (0, _core.t)('Partition Chart'),
  tags: [(0, _core.t)('Categorical'), (0, _core.t)('Comparison'), (0, _core.t)('Legacy'), (0, _core.t)('Proportional')],
...
class PartitionChartPlugin extends _core.ChartPlugin {
  constructor() {
    super({
      loadChart: () => Promise.resolve().then(() => _interopRequireWildcard(require('./ReactPartition'))),
      metadata,
