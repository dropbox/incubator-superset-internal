...
export default function DefaultTooltipRenderer({
  ...
  return ___EmotionJSX(TooltipFrame, null, ___EmotionJSX("div", null, ___EmotionJSX("strong", {
    style: {
      color
    }
  }, label)), data.length > 0 && ___EmotionJSX("br", null), ___EmotionJSX(TooltipTable, {
    data: data
  }));
}