...
export function ColumnOption({
  ...
  return ___EmotionJSX(StyleOverrides, null, showType && type !== undefined && ___EmotionJSX(ColumnTypeLabel, {
    type: type
  }), column.is_certified && ___EmotionJSX(CertifiedIconWithTooltip, {
    metricName: column.metric_name,
    certifiedBy: column.certified_by,
    details: column.certification_details
  }), showTooltip ? ___EmotionJSX(Tooltip, {
    ...
    ref: labelRef
  }, column.verbose_name || column.column_name)) : ___EmotionJSX("span", {
    className: "m-r-5 option-label column-option-label",
    ref: labelRef
