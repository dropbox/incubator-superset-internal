...
const row_limit = {
  ...
  description: t('Limits the number of rows that get displayed. Should be used in conjunction with a sort ' + 'by metric.')
};
const limit = {
  type: 'SelectControl',
  freeForm: true,
  ...
  clearable: true,
  description: t('Limits the number of series that get displayed. Should be used in conjunction with a sort ' + 'by metric. A joined subquery (or an extra phase where subqueries are not supported) is ' + 'applied to limit the number of series that get fetched and rendered. This feature is ' + 'useful when grouping by high cardinality column(s) though does increase the query ' + 'complexity and cost.')
};
const series_limit = {
  type: 'SelectControl',
  freeForm: true,
...
const sort_by = {
  ...
  label: t('Sort by'),
  default: null,
  description: t('Metric used to define the top series. Should be used in conjunction with the series or row ' + 'limit'),
  mapStateToProps: ({
    datasource
  }) => ({
