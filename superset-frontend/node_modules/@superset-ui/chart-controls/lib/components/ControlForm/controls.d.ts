...
export declare const ControlFormItemComponents: {
    Slider: React.ForwardRefExoticComponent<(import("antd").SliderSingleProps | import("antd/lib/slider").SliderRangeProps) & React.RefAttributes<unknown>>;
    InputNumber: (<T extends string | number = string | number>(props: import("antd").InputNumberProps<T> & {
