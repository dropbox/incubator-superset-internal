...
import { extractTimegrain, getNumberFormatter, getTimeFormatter, getTimeFormatterForGranularity, NumberFormats, smartDateFormatter } from '@superset-ui/core';
...
export default function transformProps(chartProps) {
  ...
  const headerFormatter = headerFormatSelector ? getTimeFormatter(headerTimestampFormat) : getNumberFormatter(yAxisFormat);
  const formatTime = timeFormat === smartDateFormatter.id ? getTimeFormatterForGranularity(granularity) : getTimeFormatter(timeFormat);
  return {
    width,
    height,
    bigNumber,
