...
declare const _default: import("@emotion/styled").StyledComponent<Pick<BigNumberVisProps, "width" | "height" | "bigNumber" | "bigNumberFallback" | "fromDatetime" | "toDatetime" | "timestamp" | "trendLineData"> & Partial<Pick<BigNumberVisProps, "className" | "headerFontSize" | "showTimestamp" | "showTrendLine" | "startYAxisAtZero" | "subheader" | "subheaderFontSize" | "timeRangeFixed" | "headerFormatter" | "formatTime" | "kickerFontSize" | "mainColor">> & Partial<Pick<{
    className: string;
    headerFormatter: NumberFormatter;
    formatTime: TimeFormatter;
    headerFontSize: number;
