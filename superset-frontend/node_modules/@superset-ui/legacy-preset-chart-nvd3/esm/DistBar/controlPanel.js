...
const config = {
  controlPanelSections: [sections.legacyRegularTime, {
    ...
    expanded: true,
    controlSetRows: [['color_scheme'], [showLegend], [showBarValue], [barStacked], [{
      name: 'order_bars',
      config: {
        type: 'CheckboxControl',
        label: t('Sort Bars'),
    ...
    groupby: {
      ...
      mapStateToProps: (state, controlState) => {
        ...
        groupbyProps.canDropValue = column => {
          ...
          return !ensureIsArray((_state$controls = state.controls) == null ? void 0 : (_state$controls$colum = _state$controls.columns) == null ? void 0 : _state$controls$colum.value).includes(column.column_name);
        };
    ...
    columns: {
      ...
      mapStateToProps: (state, controlState) => {
        ...
        columnsProps.canDropValue = column => {
          ...
          return !ensureIsArray((_state$controls2 = state.controls) == null ? void 0 : (_state$controls2$grou = _state$controls2.groupby) == null ? void 0 : _state$controls2$grou.value).includes(column.column_name);
        };
