...
function setTooltipContent(formData, verboseMap) {
  return o => {
    ...
    const label = (verboseMap == null ? void 0 : verboseMap[formData.point_radius_fixed.value]) || getMetricLabel((_formData$point_radiu = formData.point_radius_fixed) == null ? void 0 : _formData$point_radiu.value);
