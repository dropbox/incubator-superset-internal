...
exports.getDatasourceParameter = getDatasourceParameter;
...
function showModal(options) {
  ...
  (0, _jquery.default)(options.titleSelector).html(options.title || '');
  (0, _jquery.default)(options.bodySelector).html(options.body || '');
  (0, _jquery.default)(options.modalSelector).modal('show');
}
