  ...
  render() {
    ...
    return ___EmotionJSX(WithLegend, {
      ...
      renderChart: parent => ___EmotionJSX(Histogram, {
        ...
        }, datum.bin0, " to ", datum.bin1), ___EmotionJSX("div", null, ___EmotionJSX("strong", null, t('count'), " "), datum.count), ___EmotionJSX("div", null, ___EmotionJSX("strong", null, t('cumulative'), " "), datum.cumulative), ___EmotionJSX("div", null, ___EmotionJSX("strong", null, t('percentile (exclusive)'), " "), `{((datum.cumulativeDensity - datum.density) * 100).toPrecision(4)}th`)),
