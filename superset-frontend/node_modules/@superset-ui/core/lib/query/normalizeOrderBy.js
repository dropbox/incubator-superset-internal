...
exports.default = normalizeOrderBy;
...
function normalizeOrderBy(queryObject) {
  if (Array.isArray(queryObject.orderby) && queryObject.orderby.length > 0) {
    ...
    if (Array.isArray(orderbyClause) && orderbyClause.length === 2 && !(0, _isEmpty.default)(orderbyClause[0]) && (0, _isBoolean.default)(orderbyClause[1])) {
      return queryObject;
    }
  ...
  if (queryObject.timeseries_limit_metric !== undefined && queryObject.timeseries_limit_metric !== null && !(0, _isEmpty.default)(queryObject.timeseries_limit_metric)) {
  ...
  if (queryObject.legacy_order_by !== undefined && queryObject.legacy_order_by !== null && !(0, _isEmpty.default)(queryObject.legacy_order_by)) {
    return { ...cloneQueryObject,
      // @ts-ignore
