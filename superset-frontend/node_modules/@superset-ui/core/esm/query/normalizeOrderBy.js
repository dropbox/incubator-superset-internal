...
export default function normalizeOrderBy(queryObject) {
  if (Array.isArray(queryObject.orderby) && queryObject.orderby.length > 0) {
    ...
    if (Array.isArray(orderbyClause) && orderbyClause.length === 2 && !isEmpty(orderbyClause[0]) && isBoolean(orderbyClause[1])) {
      return queryObject;
    }
  ...
  if (queryObject.timeseries_limit_metric !== undefined && queryObject.timeseries_limit_metric !== null && !isEmpty(queryObject.timeseries_limit_metric)) {
  ...
  if (queryObject.legacy_order_by !== undefined && queryObject.legacy_order_by !== null && !isEmpty(queryObject.legacy_order_by)) {
    return { ...cloneQueryObject,
      // @ts-ignore
