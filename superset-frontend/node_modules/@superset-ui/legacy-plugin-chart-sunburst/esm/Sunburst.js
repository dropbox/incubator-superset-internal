...
const propTypes = {
  ...
  metrics: PropTypes.arrayOf(PropTypes.oneOfType([PropTypes.string, PropTypes.object // The metric object
  ]))
};
...
function Sunburst(element, props) {
  ...
  const partition = d3.layout.partition().size([2 * Math.PI, radius * radius]).value(d => d.m1);
