...
function Sunburst(element, props) {
  ...
  function updateBreadcrumbs(sequenceArray, percentageString) {
    ...
    }).attr('class', 'step-label').text(d => d.name.replace(/_/g, ' ')).call(_wrapSvgText.default, breadcrumbWidth, breadcrumbDims.height / 2); // Set position for entering and updating nodes.
