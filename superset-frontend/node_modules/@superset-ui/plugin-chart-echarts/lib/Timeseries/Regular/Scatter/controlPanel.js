...
const config = {
  controlPanelSections: [_chartControls.sections.legacyTimeseriesTime, {
    ...
    expanded: true,
    controlSetRows: [['metrics'], ['groupby'], ['adhoc_filters'], _chartControls.emitFilterControl, ['limit'], ['timeseries_limit_metric'], [{
      name: 'order_desc',
      config: {
    ...
    expanded: true,
    controlSetRows: [['color_scheme'], ..._controls.showValueSection, [{
      name: 'markerEnabled',
      config: {
        type: 'CheckboxControl',
