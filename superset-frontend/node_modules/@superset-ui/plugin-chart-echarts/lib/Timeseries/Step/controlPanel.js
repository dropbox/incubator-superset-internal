...
const config = {
  controlPanelSections: [_chartControls.sections.legacyTimeseriesTime, {
    ...
    controlSetRows: [['color_scheme'], [{
      ...
      config: {
        type: 'SelectControl',
        label: (0, _core.t)('Step type'),
        renderTrigger: true,
        default: _types.EchartsTimeseriesSeriesType.Start,
        choices: [[_types.EchartsTimeseriesSeriesType.Start, 'Start'], [_types.EchartsTimeseriesSeriesType.Middle, 'Middle'], [_types.EchartsTimeseriesSeriesType.End, 'End']],
        description: (0, _core.t)('Defines whether the step should appear at the beginning, middle or end between two data points')
      }
