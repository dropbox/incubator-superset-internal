  ...
  constructor() {
    super({
      ...
      metadata: new _core.ChartMetadata({
        ...
        description: (0, _core.t)('Visualize two different time series using the same x-axis time range. Note that each time series can be visualized differently (e.g. 1 using bars and 1 using a line).'),
        ...
        name: (0, _core.t)('Mixed Time-Series'),
        thumbnail: _thumbnail.default,
        tags: [(0, _core.t)('Aesthetic'), (0, _core.t)('ECharts'), (0, _core.t)('Experimental'), (0, _core.t)('Line'), (0, _core.t)('Multi-Variables'), (0, _core.t)('Predictive'), (0, _core.t)('Time'), (0, _core.t)('Transformable')]
      }),
      // @ts-ignore
