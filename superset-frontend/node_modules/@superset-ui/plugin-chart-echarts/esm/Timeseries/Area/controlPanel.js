...
const config = {
  controlPanelSections: [sections.legacyTimeseriesTime, {
    ...
    }], ['adhoc_filters'], emitFilterControl, ['limit'], ['timeseries_limit_metric'], [{
      name: 'order_desc',
      config: {
  ...
  }, sections.advancedAnalyticsControls, sections.annotationsAndLayersControls, sections.forecastIntervalControls, sections.titleControls, {
    ...
    controlSetRows: [['color_scheme'], [{
      ...
      config: {
        ...
        renderTrigger: true,
        default: seriesType,
        choices: [[EchartsTimeseriesSeriesType.Line, 'Line'], [EchartsTimeseriesSeriesType.Smooth, 'Smooth Line'], [EchartsTimeseriesSeriesType.Start, 'Step - start'], [EchartsTimeseriesSeriesType.Middle, 'Step - middle'], [EchartsTimeseriesSeriesType.End, 'Step - end']],
    ...
    }], ...richTooltipSection, // eslint-disable-next-line react/jsx-key
    [___EmotionJSX("h1", {
      className: "section-header"
