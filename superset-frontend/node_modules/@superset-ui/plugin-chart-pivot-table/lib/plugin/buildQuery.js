...
function buildQuery(formData) {
  ...
  return (0, _core.buildQueryContext)(formData, baseQueryObject => {
    const queryObject = (0, _core.normalizeOrderBy)({ ...baseQueryObject,
      order_desc,
      legacy_order_by
    });
    const {
    ...
    const orderBy = (0, _core.ensureIsArray)(legacy_order_by);

    if (orderBy.length && !(metrics != null && metrics.find(metric => (0, _core.getMetricLabel)(metric) === (0, _core.getMetricLabel)(orderBy[0])))) {
