...
const aggregatorsFactory = formatter => ({
  Count: _Utilities.aggregatorTemplates.count(formatter),
  'Count Unique Values': _Utilities.aggregatorTemplates.countUnique(formatter),
  'List Unique Values': _Utilities.aggregatorTemplates.listUnique(', ', formatter),
  Sum: _Utilities.aggregatorTemplates.sum(formatter),
  Average: _Utilities.aggregatorTemplates.average(formatter),
  Median: _Utilities.aggregatorTemplates.median(formatter),
  'Sample Variance': _Utilities.aggregatorTemplates.var(1, formatter),
  'Sample Standard Deviation': _Utilities.aggregatorTemplates.stdev(1, formatter),
  Minimum: _Utilities.aggregatorTemplates.min(formatter),
  Maximum: _Utilities.aggregatorTemplates.max(formatter),
  First: _Utilities.aggregatorTemplates.first(formatter),
  Last: _Utilities.aggregatorTemplates.last(formatter),
  'Sum as Fraction of Total': _Utilities.aggregatorTemplates.fractionOf(_Utilities.aggregatorTemplates.sum(), 'total', formatter),
  'Sum as Fraction of Rows': _Utilities.aggregatorTemplates.fractionOf(_Utilities.aggregatorTemplates.sum(), 'row', formatter),
  'Sum as Fraction of Columns': _Utilities.aggregatorTemplates.fractionOf(_Utilities.aggregatorTemplates.sum(), 'col', formatter),
  'Count as Fraction of Total': _Utilities.aggregatorTemplates.fractionOf(_Utilities.aggregatorTemplates.count(), 'total', formatter),
  'Count as Fraction of Rows': _Utilities.aggregatorTemplates.fractionOf(_Utilities.aggregatorTemplates.count(), 'row', formatter),
  'Count as Fraction of Columns': _Utilities.aggregatorTemplates.fractionOf(_Utilities.aggregatorTemplates.count(), 'col', formatter)
});
...
function PivotTableChart(props) {
  ...
  }, (0, _react2.jsx)(PivotTableWrapper, null, (0, _react2.jsx)(_PivotTable.default, {
    data: unpivotedData,
    rows: rows,
    cols: cols,
