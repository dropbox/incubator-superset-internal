...
var require_src = __commonJS({
  "libs/commands/init/src/index.ts"(exports2, module2) {
    ...
    var InitCommand = class extends Command {
      ...
      ensureGitIgnore() {
        const gitIgnorePath = import_path11.default.join(this.project.rootPath, ".gitignore");
        let chain = Promise.resolve();
      ...
      ensureConfig() {
        ...
        if (!hasExistingPackageJson) {
          ...
          chain = chain.then(() => {
            ...
            return (0, import_devkit2.writeJsonFile)(import_path11.default.join(this.project.rootPath, "package.json"), pkg, {
              spaces: 2
            });
          });
        } else {
