...
function formatColumns(resultList, viewOptions) {
  const formattedResults = resultList.map((result) => {
    ...
    formatted.location = import_chalk2.default.grey(import_path8.default.relative(".", result.location));
    return formatted;
  });
  return trimmedColumns(formattedResults, viewOptions);
}
var import_chalk2, import_columnify, import_path8;
...
var import_graceful_fs, import_is_stream, import_make_dir, import_path12, import_temp_dir, import_util, uuid, writeFileP, tempfile, writeStream;
