...
var import_npmlog11, import_write_file_atomic;
...
var import_clone_deep, import_dedent3, import_execa, import_npmlog14, import_os, DEFAULT_CONCURRENCY;
...
var import_assert, import_fs3, import_path8, ConfigChain, Conf;
var init_conf = __esm({
  "libs/core/src/lib/npm-conf/conf.ts"() {
    "use strict";
...
async function tempWrite(fileContent, filePath) {
  ...
  await (0, import_make_dir.default)(import_path9.default.dirname(tempPath));
  await write(tempPath, fileContent);
  return tempPath;
}
var import_graceful_fs, import_is_stream, import_make_dir, import_path9, import_temp_dir, import_util, uuid, writeFileP, tempfile, writeStream;
var init_temp_write = __esm({
  "libs/core/src/lib/temp-write.ts"() {
    ...
    tempfile = (filePath) => import_path9.default.join(import_temp_dir.default, uuid.v4(), filePath || "");
    ...
    tempWrite.sync = (fileContent, filePath) => {
      const tempPath = tempfile(filePath);
      import_make_dir.default.sync(import_path9.default.dirname(tempPath));
...
var import_node_fetch, import_npmlog34, import_path10, GitLabClient;
...
module.exports = require_create_release();
