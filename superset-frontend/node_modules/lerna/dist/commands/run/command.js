...
var import_graceful_fs, import_is_stream, import_make_dir, import_path11, import_temp_dir, import_util2, uuid, writeFileP, tempfile, writeStream;
    ...
    var RunCommand = class extends Command {
      ...
      async runScriptsUsingNx() {
        ...
        if (this.options.profile) {
          ...
          process.env.NX_PROFILE = import_path12.default.relative(this.project.rootPath, absolutePath);
        }
      ...
      async prepNxOptions() {
        const nxJsonExists = (0, import_fs_extra11.existsSync)(import_path12.default.join(this.project.rootPath, "nx.json"));
