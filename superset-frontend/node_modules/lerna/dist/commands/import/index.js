  ...
  "libs/commands/import/src/index.ts"(exports2, module2) {
    ...
    var ImportCommand = class extends Command {
      ...
      initialize() {
        ...
        const externalRepoPath = import_path11.default.resolve(inputPath);
        const externalRepoBase = import_path11.default.basename(externalRepoPath);
        ...
        const packageJson = import_path11.default.join(externalRepoPath, "package.json");
        ...
        const targetDir = import_path11.default.join(targetBase, externalRepoBase);
        const gitRepoRoot = this.getWorkspaceRoot();
        const lernaRootRelativeToGitRoot = import_path11.default.relative(gitRepoRoot, this.project.rootPath);
        this.targetDirRelativeToGitRoot = import_path11.default.join(lernaRootRelativeToGitRoot, targetDir);
        if (import_fs_extra11.default.existsSync(import_path11.default.resolve(this.project.rootPath, targetDir))) {
      ...
      getPackageDirectories() {
        return this.project.packageConfigs.filter((p) => p.endsWith("*")).map((p) => import_path11.default.dirname(p));
      }
      getTargetBase() {
