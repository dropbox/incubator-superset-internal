    ...
    return new Promise((resolve, reject) => {
      (0, import_conventional_recommended_bump.default)(options, (err, data) => {
        ...
        if (prereleaseId) {
          ...
          resolve(applyBuildMetadata(import_semver3.default.inc(pkg.version, prereleaseType, prereleaseId), buildMetadata));
        } else {
          ...
          resolve(applyBuildMetadata(import_semver3.default.inc(pkg.version, releaseType), buildMetadata));
        }
      });
    });
  });
      ...
      ensureConfig() {
        ...
        if (!hasExistingPackageJson) {
          ...
          chain = chain.then(() => {
            ...
            return (0, import_devkit2.writeJsonFile)(import_path18.default.join(this.project.rootPath, "package.json"), pkg, {
              spaces: 2
            });
          });
        } else {
...
var require_update_lockfile_version = __commonJS({
  "libs/commands/version/src/lib/update-lockfile-version.ts"(exports, module2) {
    ...
    function updateLockfileVersion(pkg) {
      const lockfilePath = import_path18.default.join(pkg.location, "package-lock.json");
      let chain = Promise.resolve();
      chain = chain.then(
  ...
  "libs/commands/publish/src/index.ts"(exports, module2) {
    ...
    var PublishCommand = class extends Command {
      ...
      resetChanges() {
        ...
        const dirtyManifests = [this.project.manifest].concat(this.packagesToPublish).map((pkg) => import_path18.default.relative(cwd, pkg.manifestLocation));
      ...
      execScript(pkg, script) {
        const scriptLocation = import_path18.default.join(pkg.location, "scripts", script);
        try {
        ...
        const mapper = (0, import_p_pipe.default)(
          ...[
            ...
            (pkg) => pulseTillDone(packDirectory(pkg, pkg.location, opts)).then((packed) => {
              tracker.verbose("packed", import_path18.default.relative(this.project.rootPath, pkg.contents));
              tracker.completeWork(1);
              pkg.packed = packed;
              return pkg.refresh();
            })
...
if (importLocal(__filename)) {
  ...
  require_src12()(process.argv.slice(2));
}
