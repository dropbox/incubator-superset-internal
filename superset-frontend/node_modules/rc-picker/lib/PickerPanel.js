...
function PickerPanel(props) {
  ...
  switch (mergedMode) {
    case 'decade':
      panelNode = /*#__PURE__*/React.createElement(_DecadePanel.default, Object.assign({}, pickerProps, {
    ...
    case 'year':
      panelNode = /*#__PURE__*/React.createElement(_YearPanel.default, Object.assign({}, pickerProps, {
        onSelect: function onSelect(date, type) {
          setViewDate(date);
          triggerSelect(date, type);
        }
    ...
    case 'month':
      panelNode = /*#__PURE__*/React.createElement(_MonthPanel.default, Object.assign({}, pickerProps, {
        onSelect: function onSelect(date, type) {
          setViewDate(date);
          triggerSelect(date, type);
        }
    ...
    case 'quarter':
      panelNode = /*#__PURE__*/React.createElement(_QuarterPanel.default, Object.assign({}, pickerProps, {
        onSelect: function onSelect(date, type) {
          setViewDate(date);
          triggerSelect(date, type);
        }
    ...
    case 'week':
      panelNode = /*#__PURE__*/React.createElement(_WeekPanel.default, Object.assign({}, pickerProps, {
        onSelect: function onSelect(date, type) {
          setViewDate(date);
          triggerSelect(date, type);
        }
    ...
    case 'time':
      ...
      panelNode = /*#__PURE__*/React.createElement(_TimePanel.default, Object.assign({}, pickerProps, (0, _typeof2.default)(showTime) === 'object' ? showTime : null, {
        onSelect: function onSelect(date, type) {
          setViewDate(date);
          triggerSelect(date, type);
        }
    ...
    default:
      if (showTime) {
        panelNode = /*#__PURE__*/React.createElement(_DatetimePanel.default, Object.assign({}, pickerProps, {
          onSelect: function onSelect(date, type) {
            setViewDate(date);
            triggerSelect(date, type);
          }
        ...
        panelNode = /*#__PURE__*/React.createElement(_DatePanel.default, Object.assign({}, pickerProps, {
          onSelect: function onSelect(date, type) {
            setViewDate(date);
            triggerSelect(date, type);
          }
