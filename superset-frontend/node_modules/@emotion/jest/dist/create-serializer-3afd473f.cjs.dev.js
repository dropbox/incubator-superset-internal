...
function getNodes(node, nodes) {
  ...
  if (Array.isArray(node)) {
    for (var _iterator = _createForOfIteratorHelperLoose__default['default'](node), _step; !(_step = _iterator()).done;) {
  ...
  if (node.children) {
    for (var _iterator2 = _createForOfIteratorHelperLoose__default['default'](node.children), _step2; !(_step2 = _iterator2()).done;) {
...
function clean(node, classNames) {
  if (Array.isArray(node)) {
    for (var _iterator3 = _createForOfIteratorHelperLoose__default['default'](node), _step3; !(_step3 = _iterator3()).done;) {
  ...
  if (node.children) {
    for (var _iterator4 = _createForOfIteratorHelperLoose__default['default'](node.children), _step4; !(_step4 = _iterator4()).done;) {
