...
var _ChildRegistry = _interopRequireDefault(require("./ChildRegistry"));
...
class ColorSchemeRegistry extends _registry.SyncRegistry {
  constructor({
    name = 'ColorScheme',
    ...
    this.categorical = new _ChildRegistry.default(this, {
      name: 'categorical'
    });
    this.sequential = new _ChildRegistry.default(this, {
      name: 'sequential'
    });
    this.diverging = new _ChildRegistry.default(this, {
      name: 'diverging'
    });
    this.wrappers = new _registry.SyncRegistry();
  }
  ...
  get(schemeId) {
    ...
    const wrapper = (0, _wrapColorScheme.default)(value);
