...
function _decode() {
  _decode = (0, _asyncToGenerator2.default)(_regenerator.default.mark(function _callee(gltfData, options) {
    ...
    var promises, _iterator, _step, bufferViewIndex, scenegraph;
...
function _decodeMeshoptBufferView() {
  _decodeMeshoptBufferView = (0, _asyncToGenerator2.default)(_regenerator.default.mark(function _callee2(json, index) {
    var bufferView, meshoptExtension, buffer, _meshoptExtension$byt, byteOffset, _meshoptExtension$byt2, byteLength, byteStride, count, mode, _meshoptExtension$fil, filter, source, result;
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            ...
            meshoptExtension = bufferView.extensions && bufferView.extensions[_gltfConstants.EXT_MESHOPT_COMPRESSION];
            ...
            buffer = json.buffers[meshoptExtension.buffer];
