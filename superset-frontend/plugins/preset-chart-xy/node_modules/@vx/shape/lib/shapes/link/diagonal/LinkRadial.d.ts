...
export default function LinkRadialDiagonal<Link, Node>({ className, children, data, innerRef, path, angle, radius, source, target, ...restProps }: LinkRadialDiagonalProps<Link, Node> & Omit<React.SVGProps<SVGPathElement>, keyof LinkRadialDiagonalProps<Link, Node>>): JSX.Element;
export {};
